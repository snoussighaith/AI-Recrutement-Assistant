    ...
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl">
        ...
        <Link href="/dashboard">
          <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg hover:-translate-y-1 transition cursor-pointer">
            ...
            <p className="text-gray-500 text-sm">
              Statistiques, KPIs et visualisation des données de recrutement
            </p>
            <span className="inline-block mt-4 bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-xs font-medium">
              Stats & Charts →
            </span>
          </div>
        </Link>
        ...
        <Link href="/upload">
          <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg hover:-translate-y-1 transition cursor-pointer">
            <div className="text-5xl mb-4">📄</div>
            <h2 className="text-xl font-bold text-gray-800 mb-2">Upload CV</h2>
            <p className="text-gray-500 text-sm">
              Importe un CV en PDF et extrais automatiquement les compétences
            </p>
        ...
        <Link href="/matching">
          <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg hover:-translate-y-1 transition cursor-pointer">
            <div className="text-5xl mb-4">🎯</div>
            <h2 className="text-xl font-bold text-gray-800 mb-2">Matching Offres</h2>
            <p className="text-gray-500 text-sm">
              Trouve les meilleurs candidats classés par score de pertinence
            </p>
